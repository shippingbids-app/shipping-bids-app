          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >              
              <MenuItem onClick={handleCloseNavMenu}>
                <Typography textAlign="center" component={Link} to="/offers/create" className="text-decoration-none text-dark">{pages[0]}</Typography>
              </MenuItem>
              <MenuItem onClick={handleCloseNavMenu}>
                  <Typography textAlign="center" component={Link} to="/services/create" className="text-decoration-none text-dark">{pages[1]}</Typography>
                </MenuItem>
            </Menu>
          </Box>
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              <MenuItem onClick={handleCloseUserMenu}>
                <Typography textAlign="center" component={Link} to={`/users/${user?.user?.id}` || ""} className="text-decoration-none text-dark">{settings[0]}</Typography>
              </MenuItem>
              <MenuItem onClick={handleCloseUserMenu}>
                <Typography textAlign="center" className="text-decoration-none text-danger" onClick={handleClick}>{settings[1]}</Typography>
              </MenuItem>
            </Menu>
          </Box>
        </Toolbar>
